  ...
  if (!identity) {
    return (
      <main className="page detail-page">
        <div className="error-box">无效客户端标识，无法查看日志。</div>
    ...
    <main className="page detail-page">
      <header className="page-header">
        <div className="header-content">
          ...
          <h1>日志流 · {identity.platform} / {identity.appId}</h1>
        ...
        <div className="panel-title-row">
          ...
          <div className="toolbar" style={{ gap: '0.75rem' }}>
            <div className="button-group" style={{ height: '28px', padding: '2px' }}>
              <button style={{ height: '22px' }} onClick={loadHistory}>刷新历史</button>
              <div className="divider" />
              <button style={{ height: '22px' }} onClick={() => setRecords([])}>清空日志</button>
            </div>
